...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"sf-rating"},[_vm._l((Math.ceil(_vm.finalScore)),function(index){return _vm._t("icon-positive",function(){return [_c('SfIcon',{key:("p" + index),staticClass:"sf-rating__icon",attrs:{"size":"0.875rem","icon":_vm.icon,"coverage":index === Math.ceil(_vm.finalScore) && _vm.finalScore % 1 > 0
          ? _vm.finalScore % 1
          : 1}})]})}),_vm._ssrNode(" "),_vm._l((parseInt(_vm.finalMax, 10) - Math.ceil(_vm.finalScore)),function(index){return _vm._t("icon-negative",function(){return [_c('SfIcon',{key:("n" + index),staticClass:"sf-rating__icon sf-rating__icon--negative",attrs:{"icon":_vm.icon}})]})})],2)}
var staticRenderFns = []
...
var add = __webpack_require__(4).default
module.exports.__inject__ = function (context) {
  add("95a7153c", content, true, context)
};
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('SfButton',_vm._g({staticClass:"sf-button--pure sf-color",class:{ 'is-active': _vm.selected },style:(_vm.style),attrs:{"aria-pressed":_vm.selected.toString(),"data-testid":_vm.color}},_vm.$listeners),[_c('transition',{attrs:{"name":"sf-bounce"}},[_vm._t("badge",function(){return [(_vm.selected && _vm.hasBadge)?_c('SfBadge',{staticClass:"sf-color__badge smartphone-only"},[_c('SfIcon',{attrs:{"aria-hidden":"true","icon":"check","size":"16px","color":"white"}})],1):_vm._e()]},null,{ selected: _vm.selected, hasBadge: _vm.hasBadge })],2)],1)}
var staticRenderFns = []
...
var SfRating = __webpack_require__(241);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_vue_loader_lib_index_js_vue_loader_options_Category_vue_vue_type_style_index_0_id_48d4f2b4_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(306);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_vue_loader_lib_index_js_vue_loader_options_Category_vue_vue_type_style_index_0_id_48d4f2b4_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_vue_loader_lib_index_js_vue_loader_options_Category_vue_vue_type_style_index_0_id_48d4f2b4_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_vue_loader_lib_index_js_vue_loader_options_Category_vue_vue_type_style_index_0_id_48d4f2b4_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_vue_loader_lib_index_js_vue_loader_options_Category_vue_vue_type_style_index_0_id_48d4f2b4_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "@media (min-width:1024px){.smartphone-only[data-v-48d4f2b4]{display:none!important}}@media (max-width:1023px){.desktop-only[data-v-48d4f2b4]{display:none!important}}#category[data-v-48d4f2b4]{box-sizing:border-box}@media (min-width:1024px){#category[data-v-48d4f2b4]{max-width:1240px;margin:0 auto}}.main.section[data-v-48d4f2b4]{padding:var(--spacer-xs)}@media (min-width:1024px){.main.section[data-v-48d4f2b4]{padding:0}}.breadcrumbs[data-v-48d4f2b4]{margin:var(--spacer-base) auto var(--spacer-lg)}.navbar[data-v-48d4f2b4]{position:relative;display:flex;border:solid var(--c-light);border-width:0 0 1px}@media (min-width:1024px){.navbar[data-v-48d4f2b4]{border-width:1px 0}}.navbar.section[data-v-48d4f2b4]{padding:var(--spacer-sm)}@media (min-width:1024px){.navbar.section[data-v-48d4f2b4]{padding:0}}.navbar__aside[data-v-48d4f2b4],.navbar__main[data-v-48d4f2b4]{display:flex;align-items:center;padding:var(--spacer-sm) 0}.navbar__aside[data-v-48d4f2b4]{flex:0 0 15%;padding:var(--spacer-sm) var(--spacer-sm);border:solid var(--c-light);border-width:0 1px 0 0}.navbar__main[data-v-48d4f2b4]{flex:1;padding:0;justify-content:space-between}@media (min-width:1024px){.navbar__main[data-v-48d4f2b4]{padding:var(--spacer-xs) var(--spacer-xl)}}.navbar__title[data-v-48d4f2b4]{--heading-title-font-weight:var(--font-weight--semibold);--heading-title-font-size:var(--font-size--xl)}.navbar__filters-icon[data-v-48d4f2b4]{margin:0 0 0 var(--spacer-xs);order:1}@media (min-width:1024px){.navbar__filters-icon[data-v-48d4f2b4]{margin:0 var(--spacer-xs) 0 0;order:0}}.navbar__filters-button[data-v-48d4f2b4]{display:flex;align-items:center;--button-font-size:var(--font-size--base);--button-text-decoration:none;--button-color:var(--c-link);--button-font-weight:var(--font-weight--normal)}@media (max-width:1023px){.navbar__filters-button[data-v-48d4f2b4]{--button-font-weight:var(--font-weight--medium);order:2}}.navbar__filters-button svg[data-v-48d4f2b4]{fill:var(--c-text-muted);transition:fill .15s ease}.navbar__filters-button:hover svg[data-v-48d4f2b4]{fill:var(--c-primary)}.navbar__label[data-v-48d4f2b4]{font-family:var(--font-family--secondary);font-weight:var(--font-weight--normal);color:var(--c-text-muted)}@media (min-width:1024px){.navbar__label[data-v-48d4f2b4]{color:var(--c-link);margin:0 var(--spacer-2xs) 0 0}}.navbar__select[data-v-48d4f2b4]{--select-width:220px;--select-padding:0;--select-height:auto;--select-selected-padding:0 var(--spacer-lg) 0 var(--spacer-2xs);--select-margin:0;--select-option-font-size:var(--font-size-sm);--select-error-message-height:0}.navbar__select[data-v-48d4f2b4]  .sf-select__dropdown{font-size:var(--font-size-sm);font-family:var(--font-family--secondary);font-weight:var(--font-weight--light);margin:0}.navbar__select[data-v-48d4f2b4]  .sf-select__placeholder{--select-option-font-size:var(--font-size-sm)}.navbar__sort[data-v-48d4f2b4]{display:flex;align-items:center;margin:0 auto 0 var(--spacer-2xl)}.navbar__counter[data-v-48d4f2b4]{font-family:var(--font-family--secondary);order:1}@media (min-width:1024px){.navbar__counter[data-v-48d4f2b4]{margin:auto 0 auto auto;order:0}}.navbar__view[data-v-48d4f2b4]{display:flex;align-items:center;order:0}@media (min-width:1024px){.navbar__view[data-v-48d4f2b4]{margin:0 0 0 var(--spacer-2xl);order:0}}.navbar__view-icon[data-v-48d4f2b4]{cursor:pointer;margin:0 var(--spacer-base) 0 0}.navbar__view-icon[data-v-48d4f2b4]:last-child{margin:0}.navbar__view-label[data-v-48d4f2b4]{margin:0 var(--spacer-sm) 0 0;font:var(--font-weight--normal) var(--font-size--base)/1.6 var(--font-family--secondary);text-decoration:none;color:var(--c-link)}.sort-by[data-v-48d4f2b4]{flex:unset;width:11.875rem}.main[data-v-48d4f2b4]{display:flex}.sidebar[data-v-48d4f2b4]{flex:0 0 15%;padding:var(--spacer-sm);border:solid var(--c-light);border-width:0 1px 0 0}.sidebar-filters[data-v-48d4f2b4]{--sidebar-title-display:none;--sidebar-top-padding:0}@media (min-width:1024px){.sidebar-filters[data-v-48d4f2b4]{--sidebar-content-padding:0 var(--spacer-xl);--sidebar-bottom-padding:0 var(--spacer-xl)}}.list[data-v-48d4f2b4]{--menu-item-font-size:var(--font-size--sm)}.list__item[data-v-48d4f2b4]:not(:last-of-type){--list-item-margin:0 0 var(--spacer-sm) 0}.list__item .nuxt-link-exact-active[data-v-48d4f2b4]{text-decoration:underline}.products[data-v-48d4f2b4]{box-sizing:border-box;flex:1;margin:0}.products__grid[data-v-48d4f2b4]{justify-content:space-between}@media (min-width:1024px){.products__grid[data-v-48d4f2b4]{justify-content:flex-start}}.products__grid[data-v-48d4f2b4],.products__list[data-v-48d4f2b4]{display:flex;flex-wrap:wrap}.products__product-card[data-v-48d4f2b4]{--product-card-title-margin:var(--spacer-base) 0 0 0;--product-card-title-font-weight:var(--font-weight--medium);--product-card-title-margin:var(--spacer-xs) 0 0 0;flex:1 1 50%}@media (min-width:1024px){.products__product-card[data-v-48d4f2b4]{--product-card-title-font-weight:var(--font-weight--normal);--product-card-add-button-bottom:var(--spacer-base);--product-card-title-margin:var(--spacer-sm) 0 0 0}}.products__product-card-horizontal[data-v-48d4f2b4]{flex:0 0 100%}.products__slide-enter[data-v-48d4f2b4]{opacity:0;transform:scale(.5)}.products__slide-enter-active[data-v-48d4f2b4]{transition:all .2s ease;transition-delay:calc(0.1s*var(--index))}@media (min-width:1024px){.products__grid[data-v-48d4f2b4]{margin:var(--spacer-sm) 0 0 var(--spacer-sm)}.products__pagination[data-v-48d4f2b4]{display:flex;justify-content:flex-start;margin:var(--spacer-xl) 0 0 0}.products__product-card-horizontal[data-v-48d4f2b4]{margin:var(--spacer-lg) 0}.products__product-card[data-v-48d4f2b4]{flex:1 1 20%}.products__list[data-v-48d4f2b4]{margin:0 0 0 var(--spacer-sm)}}.products__show-on-page[data-v-48d4f2b4]{display:flex;justify-content:flex-end;align-items:baseline}.products__show-on-page__label[data-v-48d4f2b4]{font-family:var(--font-family--secondary);font-size:var(--font-size--sm)}.loading[data-v-48d4f2b4]{margin:var(--spacer-3xl) auto}@media (min-width:1024px){.loading[data-v-48d4f2b4]{margin-top:6.25rem}}[data-v-48d4f2b4] .sf-sidebar__aside{--sidebar-z-index:3}.filters__title[data-v-48d4f2b4]{--heading-title-font-size:var(--font-size--xl);margin:var(--spacer-xl) 0 var(--spacer-base) 0}.filters__title[data-v-48d4f2b4]:first-child{margin:calc(var(--spacer-xl) + var(--spacer-base)) 0 var(--spacer-xs) 0}.filters__colors[data-v-48d4f2b4]{display:flex}.filters__color[data-v-48d4f2b4]{margin:var(--spacer-xs) var(--spacer-xs) var(--spacer-xs) 0}.filters__chosen[data-v-48d4f2b4]{color:var(--c-text-muted);font-weight:var(--font-weight--normal);font-family:var(--font-family--secondary);position:absolute;right:var(--spacer-xl)}.filters__item[data-v-48d4f2b4]{--radio-container-padding:0 var(--spacer-sm) 0 var(--spacer-xl);--radio-background:transparent;--filter-label-color:var(--c-secondary-variant);--filter-count-color:var(--c-secondary-variant);--checkbox-padding:0 var(--spacer-sm) 0 var(--spacer-xl);padding:var(--spacer-sm) 0;border-bottom:1px solid var(--c-light)}.filters__item[data-v-48d4f2b4]:last-child{border-bottom:0}@media (min-width:1024px){.filters__item[data-v-48d4f2b4]{--checkbox-padding:0;margin:var(--spacer-sm) 0;border:0;padding:0}}.filters__accordion-item[data-v-48d4f2b4]{--accordion-item-content-padding:0;position:relative;left:50%;right:50%;margin-left:-50vw;margin-right:-50vw;width:100vw}.filters__buttons[data-v-48d4f2b4]{margin:var(--spacer-sm) 0}.filters__button-clear[data-v-48d4f2b4]{--button-background:var(--c-light);--button-color:var(--c-dark-variant);margin:var(--spacer-xs) 0 0 0}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/Category.vue?vue&type=template&id=48d4f2b4&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"category"}},[_c('SfBreadcrumbs',{staticClass:"breadcrumbs desktop-only",attrs:{"breadcrumbs":_vm.breadcrumbs}}),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"navbar section\" data-v-48d4f2b4>","</div>",[_vm._ssrNode("<div class=\"navbar__main\" data-v-48d4f2b4>","</div>",[_c('SfButton',{staticClass:"sf-button--text navbar__filters-button",attrs:{"data-cy":"category-btn_filters","aria-label":"Filters"},on:{"click":_vm.toggleFilterSidebar}},[_c('SfIcon',{staticClass:"navbar__filters-icon",attrs:{"size":"24px","color":"dark-secondary","icon":"filter2","data-cy":"category-icon_"}}),_vm._v("\n        "+_vm._s(_vm.$t("Filters"))+"\n      ")],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"navbar__sort desktop-only\" data-v-48d4f2b4>","</div>",[_vm._ssrNode("<span class=\"navbar__label\" data-v-48d4f2b4>"+_vm._ssrEscape(_vm._s(_vm.$t("Sort by"))+":")+"</span> "),_c('SfSelect',{staticClass:"navbar__select",attrs:{"value":_vm.sortBy.selected,"placeholder":"Select sorting","data-cy":"category-select_sortBy"},on:{"input":_vm.th.changeSorting}},_vm._l((_vm.sortBy.options),function(option){return _c('SfSelectOption',{key:option.id,staticClass:"sort-by__option",attrs:{"value":option.id}},[_vm._v(_vm._s(option.value))])}),1)],2),_vm._ssrNode(" <div class=\"navbar__counter\" data-v-48d4f2b4><span class=\"navbar__label desktop-only\" data-v-48d4f2b4>"+_vm._ssrEscape(_vm._s(_vm.$t("Products found"))+":\n        ")+"</span> <span class=\"desktop-only\" data-v-48d4f2b4>"+_vm._ssrEscape(_vm._s(_vm.pagination.totalItems))+"</span> <span class=\"navbar__label smartphone-only\" data-v-48d4f2b4>"+_vm._ssrEscape(_vm._s(_vm.pagination.totalItems)+" Items")+"</span></div> "),_vm._ssrNode("<div class=\"navbar__view\" data-v-48d4f2b4>","</div>",[_vm._ssrNode("<span class=\"navbar__view-label desktop-only\" data-v-48d4f2b4>"+_vm._ssrEscape(_vm._s(_vm.$t("View")))+"</span> "),_c('SfIcon',{staticClass:"navbar__view-icon",attrs:{"data-cy":"category-icon_grid-view","color":_vm.isCategoryGridView ? 'black' : 'dark-secondary',"icon":"tiles","size":"12px","role":"button","aria-label":"Change to grid view","aria-pressed":_vm.isCategoryGridView},on:{"click":_vm.toggleCategoryGridView}}),_vm._ssrNode(" "),_c('SfIcon',{staticClass:"navbar__view-icon",attrs:{"data-cy":"category-icon_list-view","color":!_vm.isCategoryGridView ? 'black' : 'dark-secondary',"icon":"list","size":"12px","role":"button","aria-label":"Change to list view","aria-pressed":!_vm.isCategoryGridView},on:{"click":_vm.toggleCategoryGridView}})],2)],2)]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"main section\" data-v-48d4f2b4>","</div>",[_c('SfLoader',{class:{ loading: _vm.loading },attrs:{"loading":_vm.loading}},[(!_vm.loading)?_c('div',{staticClass:"products"},[(_vm.isCategoryGridView)?_c('transition-group',{staticClass:"products__grid",attrs:{"appear":"","name":"products__slide","tag":"div"}},_vm._l((_vm.products),function(product,i){return _c('SfProductCard',{key:_vm.productGetters.getId(product),staticClass:"products__product-card",style:({ '--index': i }),attrs:{"data-cy":"category-product-card","title":_vm.productGetters.getName(product),"image":_vm.productGetters.getCoverImage(product),"regular-price":_vm.$n(_vm.productGetters.getPrice(product).regular, 'currency'),"special-price":_vm.productGetters.getPrice(product).special &&
...
// CONCATENATED MODULE: ./pages/Category.vue?vue&type=template&id=48d4f2b4&scoped=true&
...
var SfColor = __webpack_require__(327);
...
var SfProductCard = __webpack_require__(328);
...
var SfAddToCart = __webpack_require__(329);
...
var SfPaginationvue_type_template_id_3c54b375_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('nav',{staticClass:"sf-pagination"},[_vm._t("prev",function(){return [_c('div',{staticClass:"sf-pagination__item prev"},[(_vm.canGoPrev)?_c(_vm.componentIs,{tag:"component",class:{
          ...
          'sf-button--pure': !_vm.hasRouter,
        },attrs:{"link":_vm.hasRouter ? _vm.getLinkTo(_vm.total) : null},on:{"click":function($event){_vm.hasRouter ? null : _vm.go(_vm.total)}}},[_vm._v("\n        "+_vm._s(_vm.total)+"\n      ")])]},null,{ page: _vm.total })]:_vm._e(),_vm._ssrNode(" "),_vm._t("next",function(){return [_c('div',{staticClass:"sf-pagination__item next"},[(_vm.canGoNext)?_c(_vm.componentIs,{tag:"component",class:{
          'sf-button--pure': !_vm.hasRouter,
...
/* harmony default export */ var Categoryvue_type_script_lang_js_ = ({
  ...
  setup(props, context) {
    const th = Object(useUiHelpers["a" /* default */])();
    const slug = context.root.$route.params.slug_1;
    const uiState = Object(useUiState["a" /* default */])();
    const {
    ...
    const {
      ...
      search,
      loading
    } = Object(index_es["g" /* useFacet */])();
    const products = Object(composition_api_["computed"])(() => index_es["b" /* facetGetters */].getProducts(result.value));
    const categoryTree = Object(composition_api_["computed"])(() => index_es["b" /* facetGetters */].getCategoryTree(result.value));
    const breadcrumbs = Object(composition_api_["computed"])(() => index_es["b" /* facetGetters */].getBreadcrumbs(result.value));
