...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('SfButton',_vm._g(_vm._b({staticClass:"sf-arrow",attrs:{"type":"button"}},'SfButton',_vm.$attrs,false),_vm.$listeners),[_vm._t("default",function(){return [_c('SfIcon',{staticClass:"sf-arrow__icon",attrs:{"size":"1.5rem","icon":"arrow_left","aria-hidden":"true"}})]})],2)}
var staticRenderFns = []
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "@media (min-width:1024px){.smartphone-only[data-v-bfd7326a]{display:none!important}}@media (max-width:1023px){.desktop-only[data-v-bfd7326a]{display:none!important}}.section[data-v-bfd7326a]{margin-top:var(--spacer-base)}.carousel[data-v-bfd7326a]{margin:0 calc(var(--spacer-sm)*-1) 0 0}@media (min-width:1024px){.carousel[data-v-bfd7326a]{margin:0}}.carousel__item[data-v-bfd7326a]{margin:1.9375rem 0 2.4375rem}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
var SfCarousel = __webpack_require__(369);
...
var SfSection = __webpack_require__(370);
...
var SfBanner = __webpack_require__(371);
...
var add = __webpack_require__(4).default
module.exports.__inject__ = function (context) {
  add("6a3868bf", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_vue_loader_lib_index_js_vue_loader_options_Home_vue_vue_type_style_index_0_id_1a7bff1e_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(313);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_vue_loader_lib_index_js_vue_loader_options_Home_vue_vue_type_style_index_0_id_1a7bff1e_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_vue_loader_lib_index_js_vue_loader_options_Home_vue_vue_type_style_index_0_id_1a7bff1e_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_vue_loader_lib_index_js_vue_loader_options_Home_vue_vue_type_style_index_0_id_1a7bff1e_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_vue_loader_lib_index_js_vue_loader_options_Home_vue_vue_type_style_index_0_id_1a7bff1e_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "@media (min-width:1024px){.smartphone-only[data-v-1a7bff1e]{display:none!important}}@media (max-width:1023px){.desktop-only[data-v-1a7bff1e]{display:none!important}}.article-meta h4 a[data-v-1a7bff1e]{color:#111;font-weight:600;font-size:20px}.article-meta[data-v-1a7bff1e]{margin-top:10px}.article-item__meta-item[data-v-1a7bff1e]:not(:last-child):after{display:inline-block;content:\"\";width:5px;height:5px;margin:-1px 10px 0;border-radius:100%;background:rgba(0,0,0,.4);vertical-align:middle}#home[data-v-1a7bff1e]{box-sizing:border-box;padding:0 var(--spacer-sm)}@media (min-width:1024px){#home[data-v-1a7bff1e]{max-width:1240px;padding:0;margin:0 auto}}.hero[data-v-1a7bff1e]{margin:var(--spacer-xl) auto var(--spacer-lg);--hero-item-background-position:center}.hero[data-v-1a7bff1e]  .sf-link:hover{color:var(--c-white)}@media (min-width:1024px){.hero[data-v-1a7bff1e]{margin:var(--spacer-xl) auto var(--spacer-2xl)}}.hero .sf-hero-item[data-v-1a7bff1e]:nth-child(2n){--hero-item-background-position:left}@media (max-width:1023px){.hero .sf-hero-item[data-v-1a7bff1e]:nth-child(2n){--hero-item-background-position:30%;--hero-item-wrapper-text-align:right;--hero-item-subtitle-width:100%;--hero-item-title-width:100%;--hero-item-wrapper-padding:var(--spacer-sm) var(--spacer-sm) var(--spacer-sm) var(--spacer-2xl)}}[data-v-1a7bff1e] .sf-hero__controls{--hero-controls-display:none}.banner-grid[data-v-1a7bff1e]{--banner-container-width:50%;margin:var(--spacer-xl) 0}.banner-grid[data-v-1a7bff1e]  .sf-link:hover{color:var(--c-white)}@media (min-width:1024px){.banner-grid[data-v-1a7bff1e]{margin:var(--spacer-2xl) 0}.banner-grid[data-v-1a7bff1e]  .sf-link{--button-width:auto}}.banner__tshirt[data-v-1a7bff1e]{background-position:0}@media (min-width:1024px){.banner-central[data-v-1a7bff1e]{--banner-container-flex:0 0 70%}}.similar-products[data-v-1a7bff1e]{display:flex;justify-content:space-between;align-items:center;padding-bottom:var(--spacer-2xs);--heading-padding:0;border-bottom:1px solid var(--c-light)}@media (min-width:1024px){.similar-products[data-v-1a7bff1e]{border-bottom:0;justify-content:center;padding-bottom:0}}.call-to-action[data-v-1a7bff1e]{background-position:100%;margin:var(--spacer-xs) 0}@media (min-width:1024px){.call-to-action[data-v-1a7bff1e]{margin:var(--spacer-xl) 0 var(--spacer-2xl) 0}}.carousel[data-v-1a7bff1e]{margin:0 calc(var(--spacer-sm)*-1) 0 0}@media (min-width:1024px){.carousel[data-v-1a7bff1e]{margin:0}}.carousel__item[data-v-1a7bff1e]{margin:1.375rem 0 2.5rem}@media (min-width:1024px){.carousel__item[data-v-1a7bff1e]{margin:var(--spacer-xl) 0 var(--spacer-xl) 0}}.carousel__item__product[data-v-1a7bff1e]{--product-card-add-button-transform:translate3d(0,30%,0)}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
var SfArrow = __webpack_require__(265);

// EXTERNAL MODULE: external "@glidejs/glide"
var glide_ = __webpack_require__(219);
...
var SfBulletsvue_type_template_id_7d0bcfcb_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('ol',{staticClass:"sf-bullets"},[_vm._l((_vm.inactiveLeft),function(_,index){return [_vm._t("inactive",function(){return [_c('li',{key:index},[_c('SfButton',{staticClass:"sf-button--pure sf-bullet",attrs:{"aria-label":'Go to slide ' + (index + 1),"data-testid":index + 1},on:{"click":function($event){return _vm.go(index)}}})],1)]},null,{ index: index, go: _vm.go })]}),_vm._ssrNode(" "),_vm._t("active",function(){return [_c('li',[_c('SfButton',{staticClass:"sf-button--pure sf-bullet is-active",attrs:{"aria-label":"Current slide"}})],1)]}),_vm._ssrNode(" "),_vm._l((_vm.inactiveRight),function(_,index){return [_vm._t("inactive",function(){return [_c('li',{key:_vm.inactiveLeft + 1 + index},[_c('SfButton',{staticClass:"sf-button--pure sf-bullet",attrs:{"aria-label":'Go to slide ' + (_vm.inactiveLeft + 2 + index),"data-testid":_vm.inactiveLeft + 1 + index},on:{"click":function($event){return _vm.go(_vm.inactiveLeft + 1 + index)}}})],1)]},null,{ index: _vm.inactiveLeft + 1 + index, go: _vm.go })]})],2)}
...
var SfCallToActionvue_type_template_id_1fffb473_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('section',{staticClass:"sf-call-to-action",style:(_vm.style)},[_vm._ssrNode("<div class=\"sf-call-to-action__text-container\">","</div>",[_vm._t("title",function(){return [(_vm.title)?_c('h2',{staticClass:"sf-call-to-action__title"},[_vm._v("\n        "+_vm._s(_vm.title)+"\n      ")]):_vm._e()]},null,{ title: _vm.title }),_vm._ssrNode(" "),_vm._t("description",function(){return [(_vm.description)?_c('p',{staticClass:"sf-call-to-action__description"},[_vm._v("\n        "+_vm._s(_vm.description)+"\n      ")]):_vm._e()]},null,{ description: _vm.description })],2),_vm._ssrNode(" "),_vm._t("button",function(){return [(_vm.buttonText)?_c('SfButton',{staticClass:"sf-call-to-action__button",attrs:{"link":_vm.link}},[_vm._v("\n      "+_vm._s(_vm.buttonText)+"\n    ")]):_vm._e()]},null,{ buttonText: _vm.buttonText })],2)}
var SfCallToActionvue_type_template_id_1fffb473_staticRenderFns = []
...
var SfCallToAction_component = Object(componentNormalizer["a" /* default */])(
  ...
  SfCallToActionvue_type_template_id_1fffb473_render,
  SfCallToActionvue_type_template_id_1fffb473_staticRenderFns,
  false,
...
// EXTERNAL MODULE: ./components/RelatedProducts.vue + 4 modules
var RelatedProducts = __webpack_require__(298);

// EXTERNAL MODULE: ./components/InstagramFeed.vue + 4 modules
var InstagramFeed = __webpack_require__(299);
...
var MobileStoreBanner = __webpack_require__(300);
...
/* harmony default export */ var Homevue_type_script_lang_js_ = ({
  ...
  setup() {
    ...
    } = Object(index_es["h" /* useProduct */])('relatedProducts');
    const {
      cart,
      load: loadCart,
      addItem: addToCart,
