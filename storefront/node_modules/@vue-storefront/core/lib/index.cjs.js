...
var maskString = function (el) { return el.charAt(0) + "***" + el.slice(-1); };
...
var createFactoryParamsReducer = function (context) { return function (prev, _a) {
    var _b;
...
var useCartFactory = function (factoryParams) {
    return function useCart() {
        ...
        var removeCoupon = function (_a) {
            var coupon = _a.coupon, customQuery = _a.customQuery;
            return __awaiter(_this, void 0, void 0, function () {
    ...
    return function useCategory(id) {
        ...
        var search = function (searchParams) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        exports.Logger.debug("useCategory/" + id + "/search", searchParams);
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        loading.value = true;
                    ...
                    case 3:
                        ...
                        exports.Logger.error("useCategory/" + id + "/search", err_1);
                        return [3 /*break*/, 5];
                    case 4:
                        loading.value = false;
                        return [7 /*endfinally*/];
    ...
    return function useContent(id) {
        ...
        var search = function (params) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        exports.Logger.debug("useContent/" + id + "/search", params);
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        loading.value = true;
                    ...
                    case 3:
                        err_1 = _b.sent();
                        error.value.search = err_1;
                        exports.Logger.error("useContent/" + id + "/search", err_1);
                        return [3 /*break*/, 5];
                    case 4:
                        loading.value = false;
                        return [7 /*endfinally*/];
...
var useFacetFactory = function (factoryParams) {
    var useFacet = function (id) {
        ...
        var loading = exports.vsfRef(false, ssrKey + "-loading");
        var result = exports.vsfRef({ data: null, input: null }, ssrKey + "-facets");
        var _factoryParams = configureFactoryParams(factoryParams);
        var error = sharedRef({
            search: null
        }, "useFacet-error-" + id);
        var search = function (params) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        exports.Logger.debug("useFacet/" + ssrKey + "/search", params);
                    ...
                    case 3:
                        err_1 = _b.sent();
                        error.value.search = err_1;
                        exports.Logger.error("useFacet/" + ssrKey + "/search", err_1);
                        return [3 /*break*/, 5];
                    case 4:
                        loading.value = false;
                        return [7 /*endfinally*/];
    ...
    return function useProduct(id) {
        ...
        var search = function (searchParams) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        exports.Logger.debug("useProduct/" + id + "/search", searchParams);
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        loading.value = true;
                    ...
                    case 3:
                        err_1 = _b.sent();
                        error.value.search = err_1;
                        exports.Logger.error("useProduct/" + id + "/search", err_1);
                        return [3 /*break*/, 5];
                    case 4:
                        loading.value = false;
                        return [7 /*endfinally*/];
    ...
    return function useReview(id) {
        ...
        var search = function (searchParams) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        exports.Logger.debug("useReview/" + id + "/search", searchParams);
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        loading.value = true;
                    ...
                    case 3:
                        err_1 = _b.sent();
                        error.value.search = err_1;
                        exports.Logger.error("useReview/" + id + "/search", err_1);
                        return [3 /*break*/, 5];
                    case 4:
                        loading.value = false;
                        return [7 /*endfinally*/];
        ...
        var addReview = function (params) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        exports.Logger.debug("useReview/" + id + "/addReview", params);
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        loading.value = true;
                    ...
                    case 3:
                        ...
                        exports.Logger.error("useReview/" + id + "/addReview", err_2);
                        return [3 /*break*/, 5];
                    case 4:
                        loading.value = false;
                        return [7 /*endfinally*/];
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            loading.value = true;
                            _b = user;
                            return [4 /*yield*/, _factoryParams.updateUser({ currentUser: user.value, updatedUserData: providedUser })];
                        case 2:
                            _b.value = _c.sent();
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            loading.value = true;
                            _b = user;
                            return [4 /*yield*/, _factoryParams.register(providedUser)];
                        case 2:
                            _b.value = _c.sent();
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            loading.value = true;
                            _b = user;
                            return [4 /*yield*/, _factoryParams.logIn(providedUser)];
                        case 2:
                            _b.value = _c.sent();
        ...
        var logout = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, _factoryParams.logOut()];
                    case 2:
                        _a.sent();
