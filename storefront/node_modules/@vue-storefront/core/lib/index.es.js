import { onServerPrefetch, ref, isRef, computed, unref } from '@vue/composition-api';
...
var useFacetFactory = function (factoryParams) {
    var useFacet = function (id) {
        ...
        var result = vsfRef({ data: null, input: null }, ssrKey + "-facets");
        var _factoryParams = configureFactoryParams(factoryParams);
        var error = sharedRef({
            search: null
        }, "useFacet-error-" + id);
...
export { AgnosticOrderStatus, Logger, apiClientFactory, configureContext, configureFactoryParams, configureSSR, generateContext, integrationPlugin, mask, onSSR, registerLogger, renderContentFactory, sharedRef, track, useBillingFactory, useCartFactory, useCategoryFactory, useContentFactory, useFacetFactory, useMakeOrderFactory, useProductFactory, useReviewFactory, useShippingFactory, useShippingProviderFactory, useUserBillingFactory, useUserFactory, useUserOrderFactory, useUserShippingFactory, useVSFContext, useWishlistFactory, vsfRef, wrap };
