...
export declare const useCartFactory: <CART, CART_ITEM, PRODUCT, COUPON>(factoryParams: UseCartFactoryParams<CART, CART_ITEM, PRODUCT, COUPON>) => () => UseCart<CART, CART_ITEM, PRODUCT, COUPON>;
