...
export declare const useWishlistFactory: <WISHLIST, WISHLIST_ITEM, PRODUCT>(factoryParams: UseWishlistFactoryParams<WISHLIST, WISHLIST_ITEM, PRODUCT>) => () => UseWishlist<WISHLIST, WISHLIST_ITEM, PRODUCT>;
