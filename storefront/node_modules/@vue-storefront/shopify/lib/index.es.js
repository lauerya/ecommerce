import { useCartFactory, useCategoryFactory, useFacetFactory, useProductFactory, useReviewFactory, useUserFactory, useUserBillingFactory, useUserOrderFactory, useUserShippingFactory, useWishlistFactory } from '@vue-storefront/core';
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, context.$shopify.api.removeFromCart({ currentCart: currentCart, product: product }).then(function (checkout) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, context.$shopify.api.updateCart({ currentCart: currentCart, product: product, quantity: quantity }).then(function (checkout) {
                                // return updated cart data
                                return JSON.parse(JSON.stringify(checkout));
                            })];
                    case 1: 
...
var index$7 = useUserOrderFactory(params$6);
